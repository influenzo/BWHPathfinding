...
public class CellGestures {
  ...
  static DragNodeSupplier NORTH =
      new DragNodeSupplier() {
        @Override
  ...
  static DragNodeSupplier NORTH_EAST =
      new DragNodeSupplier() {
        @Override
        public Node apply(Region region, Wrapper<Point2D> mouseLocation) {
          final DoubleProperty xProperty = region.layoutXProperty();
          ...
          resizeHandleNE.setOnMouseDragged(
              event -> {
                if (mouseLocation.value != null) {
                  dragNorth(event, mouseLocation, region, handleRadius);
  ...
  static DragNodeSupplier EAST =
      new DragNodeSupplier() {
        ...
        public Node apply(Region region, Wrapper<Point2D> mouseLocation) {
          ...
          resizeHandleE
              .yProperty()
              .bind(yProperty.add(halfHeightProperty).subtract(handleRadius / 2));
  ...
  static DragNodeSupplier SOUTH_EAST =
      new DragNodeSupplier() {
        @Override
        public Node apply(Region region, Wrapper<Point2D> mouseLocation) {
          final DoubleProperty xProperty = region.layoutXProperty();
          ...
          resizeHandleSE.setOnMouseDragged(
              event -> {
                if (mouseLocation.value != null) {
  ...
  static DragNodeSupplier SOUTH =
      new DragNodeSupplier() {
        ...
        public Node apply(Region region, Wrapper<Point2D> mouseLocation) {
          ...
          resizeHandleS.setOnMouseDragged(
              event -> {
                if (mouseLocation.value != null) {
                  dragSouth(event, mouseLocation, region, handleRadius);
                  mouseLocation.value = new Point2D(event.getSceneX(), event.getSceneY());
  ...
  static DragNodeSupplier SOUTH_WEST =
      new DragNodeSupplier() {
        @Override
        public Node apply(Region region, Wrapper<Point2D> mouseLocation) {
          final DoubleProperty xProperty = region.layoutXProperty();
          ...
          resizeHandleSW.setOnMouseDragged(
              event -> {
                if (mouseLocation.value != null) {
                  dragSouth(event, mouseLocation, region, handleRadius);
  ...
  static DragNodeSupplier NORTH_WEST =
      new DragNodeSupplier() {
        @Override
        public Node apply(Region region, Wrapper<Point2D> mouseLocation) {
          final DoubleProperty xProperty = region.layoutXProperty();
  ...
  public static void makeResizable(Region region, DragNodeSupplier... nodeSuppliers) {
    ...
    final List<Node> dragNodes =
        Arrays.stream(nodeSuppliers)
            .map(supplier -> supplier.apply(region, mouseLocation))
  ...
  private static void dragNorth(
      MouseEvent event, Wrapper<Point2D> mouseLocation, Region region, double handleRadius) {
